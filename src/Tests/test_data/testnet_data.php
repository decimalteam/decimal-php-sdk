...
const TESTNET_DATA = [
    ...
    'transaction' => [
        ...
        'createNftMint' => [
            ...
            'denom'=> 'phone',
            'token_uri'=> 'https://testnet-nft.decimalchain.com/api/nfts/',
            'quantity'=> '1',
            'reserve'=> '1',
            'allow_mint'=> true
        ],
        'burnNft' => [
            'denom'=> 'phone1775049594',
        ...
        'editNftMetadata' => [
            'denom'=> 'phone',
            'id'=> 'd365ab32a23117c2ad1c001633f89673d4790bf6',
            'token_uri'=> 'https://testnet-nft.decimalchain.com/api/nfts/CvavSYvudYqiGeOY67dzLmdl6NjqTdEb'
        ],
        'transferNft' => [
            'denom'=> 'phone',
            'id'=> 'd365ab32a23117c2ad1c001633f89673d4790bf6',
