 ...
 *
 * Generated from protobuf message <code>decimal.coin.v1.EventUpdateCoin</code>
 */
class EventUpdateCoin extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $denom = '';
    /**
     * Generated from protobuf field <code>string limit_volume = 3 [json_name = "limitVolume"];</code>
     */
