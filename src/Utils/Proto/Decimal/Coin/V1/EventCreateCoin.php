 ...
 *
 * Generated from protobuf message <code>decimal.coin.v1.EventCreateCoin</code>
 */
class EventCreateCoin extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $crr = 0;
    /**
     * Generated from protobuf field <code>string initial_volume = 5 [json_name = "initialVolume"];</code>
     */
    protected $initial_volume = '';
    /**
     * Generated from protobuf field <code>string initial_reserve = 6 [json_name = "initialReserve"];</code>
     */
    protected $initial_reserve = '';
    /**
     * Generated from protobuf field <code>string limit_volume = 7 [json_name = "limitVolume"];</code>
     */
    ...
    protected $identity = '';
    /**
     * Generated from protobuf field <code>string commission_create_coin = 9 [json_name = "commissionCreateCoin"];</code>
     */
    protected $commission_create_coin = '';
     ...
     *     @type string $commission_create_coin
     * }
     */
     ...
     * @return string
     */
    public function getCommissionCreateCoin()
    {
        return $this->commission_create_coin;
    }
     ...
     * @return $this
     */
    public function setCommissionCreateCoin($var)
    {
        GPBUtil::checkString($var, True);
        $this->commission_create_coin = $var;
