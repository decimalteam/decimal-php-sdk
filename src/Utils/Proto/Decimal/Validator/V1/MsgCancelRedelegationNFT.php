 ...
 *
 * Generated from protobuf message <code>decimal.validator.v1.MsgCancelRedelegationNFT</code>
 */
class MsgCancelRedelegationNFT extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>string token_id = 5 [json_name = "tokenId", (.gogoproto.customname) = "TokenID"];</code>
     */
    protected $token_id = '';
    /**
     * sub_token_ids defines list of NFT sub-token IDs.
     *
     * Generated from protobuf field <code>repeated int64 sub_token_ids = 6 [json_name = "subTokenIds", (.gogoproto.customname) = "SubTokenIDs"];</code>
     */
