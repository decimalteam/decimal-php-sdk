 ...
 *
 * Generated from protobuf message <code>decimal.validator.v1.UnbondingDelegation</code>
 */
class UnbondingDelegation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .decimal.validator.v1.UnbondingDelegationEntry entries = 3 [json_name = "entries", (.gogoproto.nullable) = false];</code>
     */
    private $entries;
     ...
     *           validator_address is the bech32-encoded address of the validator.
     *     @type \Decimal\Validator\V1\UnbondingDelegationEntry[]|\Google\Protobuf\Internal\RepeatedField $entries
     *           entries are the unbonding delegation entries.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .decimal.validator.v1.UnbondingDelegationEntry entries = 3 [json_name = "entries", (.gogoproto.nullable) = false];</code>
     * @param \Decimal\Validator\V1\UnbondingDelegationEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEntries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Decimal\Validator\V1\UnbondingDelegationEntry::class);
        $this->entries = $arr;
